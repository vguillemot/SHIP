...
<!-- badges: start -->
[![CRAN Status](https://www.r-pkg.org/badges/version/SHIP)](https://cran.r-project.org/package=SHIP){.SHIP-release}
<!-- badges: end -->
...
You can install the development version of SHIP from [GitHub](https://github.com/vguillemot/SHIP) with:
